// Settings
const proxy_url = 'dev.ffa.com:8888';
...
const paths = {
	...
	'scripts': [ 'assets/scripts/*.js',  '!assets/scripts/project.js','!assets/scripts/*.min.js', '!assets/scripts/*config.js', '!assets/scripts/customizer.js' ],
